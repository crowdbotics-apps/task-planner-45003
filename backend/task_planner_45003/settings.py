"""
Django settings for task_planner_45003 project.
...
ROOT_URLCONF = 'task_planner_45003.urls'
...
WSGI_APPLICATION = 'task_planner_45003.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "task_planner_45003 API",
    "DESCRIPTION": "API documentation for task_planner_45003 App",
    "VERSION": "v1",
}
